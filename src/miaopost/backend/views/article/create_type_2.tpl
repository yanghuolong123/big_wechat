            ...
            <form method="post" role="form" id="create_form">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <a title="点击上传图片" class="thumbnail" href="javascript:;"><img alt="点击上传图片" src=""></a>
                  <input type="hidden" name="logo" id="logo" >                  
                </div>
                <div class="form-group">
                  <label for="link">外部链接</label>
                  <input type="text" placeholder="http://" name="link" id="link" class="form-control">
                </div>
                <div class="form-group">
