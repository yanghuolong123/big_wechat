	    <title>秒Po-中国学生极简信息发布平台</title>
            ...
            <link rel="stylesheet" type="text/css" href="/static/css/common.css?{{date .version "YmdHis"}}">
            <link rel="stylesheet" type="text/css" href="/static/css/main.css?{{date .version "YmdHis"}}">
